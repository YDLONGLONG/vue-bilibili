  ...
  <div>
    ...
    <div class="type">
      <el-row type="flex" align="middle" class="left">
        <el-col :offset="3"><router-link :to="`/home`"><div><img src="../../assets/img/shouye.png"></div>&nbsp; 首页</router-link></el-col>
        <el-col><router-link :to="`/trendmaster`"><div><img src="../../assets/img/dongtai.png"></div>&nbsp; 动态</router-link></el-col>
        <el-col><router-link :to="`/top`"><div><img src="../../assets/img/remen.png"></div>&nbsp; 热门</router-link></el-col>
        <el-col><router-link :to="`/`"><div><img src="../../assets/img/pindao.png"></div>&nbsp; 频道</router-link></el-col>
      </el-row>
      <el-row>
        <ul class="middle">
          <li>动画</li>
    ...
    <div>
      <ul class="fl">
        <li v-for="(type, index) in types" :key="index">
          <el-button size="medium" :type="type.btnType" @click="getPageByType(index)" round>{{ type.name }}</el-button>
        </li>
      </ul>
    </div>
    <div class="main">
    ...
    <div class="middle">
      <!-- 标题 -->
      <div class="title">
      本站视频<el-button type="info" style="margin:0 20px">{{types[index].name}}</el-button>
      </div>
      <!-- 视频列表 -->
